...
// Import icons (assuming previous imports are correct)
...
const getStatProps = (statName) => {
    switch (statName) {
        // Keeping translucent mutedBg for sleek look
...
// REVISED: Digimon Node Component for Evolution Tree (LARGER SIZE AND TEXT)
const DigimonEvolutionNode = ({ digimon, isCurrent, navigateTo }) => {
    ...
    // REVISED: Increased base size from w-24/28 to w-28/36
    ...
    return (
        <div 
            ...
            // Adjusted container width to accommodate larger node
        ...
        >
            ...
            >
                ...
                <div className={`w-full h-full p-1 bg-dark-void/50 rounded-lg flex items-center justify-center`}> 
                    {digimon.url || digimon.image_path ? (
                        ...
                        // FIXED: Removed trailing comment on this line to fix the Babel/Vite parsing error.
                        <div className="text-text-low text-sm font-mono">NO IMAGE</div>
                    )}
                </div>
            </div>
            
            {/* REVISED: Increased font size for name */}
            ...
            {/* REVISED: Increased font size for generation */}
...
// Evolution Tree Component (Removed border/underline)
const EvolutionTree = ({ currentDigimon, evolvesFrom, evolvesTo, navigateTo }) => {
    ...
    // Thinner line with cyan gradient glow
    const EvolutionLine = () => (
    ...
    return (
        <div className="flex flex-col items-center justify-center pt-8 pb-12 relative">
            <h2 className="text-3xl font-regal tracking-wider text-accent-blue pb-2 flex items-center mb-8">
                ...
                <span className='pb-1'>DIGIVOLUTION TREE</span> {/* REMOVED BORDER/UNDERLINE */}
            </h2>
            ...
            {/* Added a subtle divider between sections */}
...
// BaseStatsGrid - REVISED: Added border and outer glow for "Lit-up Console" effect
const BaseStatsGrid = ({ stats }) => {
    ...
    return (
        // Added a clear border and box-shadow for the console effect
        <section className="py-12 relative bg-dark-panel/30 backdrop-blur-md 
            ...
            <div className="max-w-4xl mx-auto px-4 relative z-10">
                ...
                {/* Grand Total - Intense blue glow on the number */}
...
// REVISED: DataCardAbstract (No borders, simple inner shadow for depth)
const DataCardAbstract = ({ Icon, label, value, valueClass = 'text-gray-300' }) => (
    <div className="flex flex-col items-center justify-center p-3 sm:p-4 bg-dark-panel/40 rounded-lg min-w-[120px] text-center backdrop-blur-sm transition hover:bg-dark-panel/60 shadow-data-inner hover:shadow-lg hover:shadow-accent-blue/20"
         style={{ boxShadow: '0 0 5px rgba(77, 182, 255, 0.1)' }}> {/* Subtle default shadow */}
        {/* Neon Icon effect */}
...
// REVISED: Attribute Info Card (No borders, simple inner shadow for depth)
...
// Digimon Description Panel (No outer border, slightly translucent)
const DigimonDescriptionPanel = ({ description }) => (
    <div className="p-6 rounded-lg transition">
        ...
        {/* Faint data separator line (Now smoother with gradient) */}
        <div className='w-full h-px bg-gradient-to-r from-transparent via-accent-cyan/60 to-transparent mb-6'></div>
...
// REVISED: Personality Quadrant (Floating Panel - NO BORDERS)
const PersonalityQuadrant = ({ name, traits }) => {
    ...
    return (
        <div className="p-5 rounded-xl bg-dark-panel/30 transition hover:bg-dark-panel/50 relative overflow-hidden backdrop-blur-sm shadow-xl shadow-dark-void/50"
             style={{ border: '1px solid rgba(77, 182, 255, 0.1)', boxShadow: '0 0 15px rgba(77, 182, 255, 0.2)' }}> {/* Added subtle border/glow */}
        ...
        return (
            <div className="p-8 min-h-screen bg-dark-void text-white flex flex-col items-center justify-center">
                ...
                <button
                    ...
                    className="flex items-center text-lg text-accent-blue hover:text-accent-cyan transition font-mono"
                >
                    <ChevronLeft className="w-5 h-5 mr-2" /> &lt; BACK TO ARCHIVE
                </button>
            </div>
        );
    }
        ...
        <div className="min-h-screen bg-dark-void text-white pb-16">
            ...
            <div className="w-full backdrop-blur-md sticky top-0 z-30">
                <div className="max-w-6xl mx-auto px-4 py-4">
                    ...
                    >
                        <ChevronLeft className="w-6 h-6 mr-2" /> RETURN TO ARCHIVE
                    </button>
                </div>
            </div>
